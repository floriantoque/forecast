...
X_train, scaler_X = utils_regressor.scaler_fit_transform(X_train,
                                                         scaler_choice_X)
y_list_train, scaler_Y = utils_regressor.scaler_fit_transform(y_list_train,
                                                              scaler_choice_y)
...
best_params_time_series, cv_results_time_series = utils_regressor.optimize_multioutput_regressor_multiseries_model(X_train, y_list_train,
                                                                                           param_grid, param_kfold,
                                                                                           estimator,
                                                                                           verbose=0,
                                                                                           n_jobs_cv=n_jobs_cv)

utils.save_pickle_safe(path_optimization + 'best_params_time_series.pkl',
                       best_params_time_series,
