...
# Data
#'/home/toque/data2/montreal/stm/data/valid_metro_2015_2016_2017_perpass_agregated/valid_metro_15min_2015_2016_2017_A-Mensuel_STM.csv'
#'/home/toque/data2/montreal/stm/data/valid_metro_2015_2016_2017_perpass_agregated/valid_metro_15min_2015_2016_2017_B-Mensuel_regional'
#'/home/toque/data2/montreal/stm/data/valid_metro_2015_2016_2017_perpass_agregated/valid_metro_15min_2015_2016_2017_C-Carnets_de_billets'
#'/home/toque/data2/montreal/stm/data/valid_metro_2015_2016_2017_perpass_agregated/valid_metro_15min_2015_2016_2017_D-Titres_occasionnels.csv'
...
if len(exogenous_data_path)>0:
    df_exogenous = read_csv_list(exogenous_data_path)
else:
    df_exogenous=None

df_context = read_csv_list(context_data_path).fillna(0)
...
features_context = ['Day_id', 'Mois_id','vac_noel_quebec', 'day_off_quebec', '24DEC', '31DEC',
                    ...
                    'trend_11', 'trend_32', 'trend_34', 'trend_15',
                    'trend_44', 'trend_65', 'trend_31', 'trend_33', 'trend_35',
                    'trend_47', 'trend_13', 'trend_14', 'trend_1', 'trend_9', 'trend_5',
                    'trend_18', 'trend_36', 'trend_24', 'trend_68', 'trend_43',
                    'trend_8', 'trend_64', 'trend_10', 'trend_55', 'trend_3',
                    'trend_49', 'trend_51', 'trend_2', 'trend_19', 'trend_56',
                    'trend_7', 'trend_6', 'trend_4', 'trend_48', 'trend_66', 'trend_25',
                    'trend_23', 'trend_28', 'trend_39', 'trend_54', 'trend_60',
                    'trend_27', 'trend_20', 'trend_46', 'trend_12', 'trend_21',
                    'trend_62', 'trend_52', 'trend_41', 'trend_50', 'trend_30',
                    'trend_16', 'trend_37', 'trend_40', 'trend_26', 'trend_67',
                    'trend_57', 'trend_61', 'trend_42', 'trend_45', 'trend_38',
                    'trend_29', 'trend_58', 'trend_63', 'trend_22', 'trend_59',
                    'trend_53', 'trend_17']
...
# end datetime has to finish by 23:45:00 for a complete day
start_datetime, end_datetime = '2015-01-01 00:00:00', '2016-12-31 23:45:00'




model_name = 'lt_rf_uni_inverted_event_category_alltrend30_trend_r_stl_opti'
...
try:
    ...
    df_Xy = df_observation.set_index('Datetime').join([df_context.set_index('Datetime')])

# reduce useless features full of 0
df_Xy = df_Xy.loc['2015-01-01 00:00:00' : '2017-12-31 23:45:00'][time_series+features_exogenous+features_context]
features_to_delete = np.array(time_series+features_exogenous+features_context)[(df_Xy==0).sum(axis=0)==len(df_Xy)]
...
df_Xy_train = df_Xy.loc[start_datetime:end_datetime]
